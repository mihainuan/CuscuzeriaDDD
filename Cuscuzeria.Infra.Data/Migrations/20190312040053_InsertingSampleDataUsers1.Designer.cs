...
namespace Cuscuzeria.Infra.Data.Migrations
{
    ...
    [Migration("20190312040053_InsertingSampleDataUsers1")]
    partial class InsertingSampleDataUsers1
    {
            ...
            modelBuilder.Entity("Cuscuzeria.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 12, CreatedAt = new DateTime(2019, 3, 12, 1, 0, 52, 706, DateTimeKind.Local), Email = "ekspr@email.com", LastOrder = new DateTime(2019, 3, 12, 0, 0, 0, 0, DateTimeKind.Local), Password = "SZ@111222", Phone = "+55719988-7733", Username = "ekspr" }
                    );
                });
